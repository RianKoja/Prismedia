...
const allowedTransitionalApiImports = new Set([
  ...
  "apps/web-svelte/src/lib/components/CommandPalette.svelte",
  ...
  "apps/web-svelte/src/lib/components/entities/entity-index-page.svelte.ts",
  ...
  "apps/web-svelte/src/lib/entities/entity-relationship-thumbnails.ts",
  "apps/web-svelte/src/lib/entities/entity-route-resolver.ts",
  ...
  "apps/web-svelte/src/routes/search/+page.svelte",
