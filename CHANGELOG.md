...
- Identify now fills a match in pieces instead of making you wait on the whole thing. Picking a result identifies the parent and opens its review right away, then its children (a series' episodes, an artist's albums, an album's tracks) resolve one at a time and pop in as they match — each as a square cover for music. Children that can't be matched show grayed out as "No match found", you can cancel or re-identify any child, and Accept stays disabled until every child has settled. Resolved children are saved as they come back, so navigating away or refreshing the page keeps the progress you've already made.
