...
### Added
- Sidebar sections can now be collapsed. Click a section header (Overview, Browse, Operate, or any you've made) to fold its items away, and the collapsed/expanded state is saved per device alongside the rest of your navigation layout, so the sidebar reopens exactly how you left it.
