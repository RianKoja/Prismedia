...
public sealed class PrismediaDbContextModelTests {
    ...
    [InlineData(typeof(UserLibraryAccessRow), "user_library_access")]
    ...
    [InlineData(typeof(UserEntityStateRow), nameof(UserEntityStateRow.ProgressCurrentEntityId), "progress_current_entity_id")]
